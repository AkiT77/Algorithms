import unittest
from counting_sort import counting_sort_function

class TestBinarySearch(unittest.TestCase):
    def test_ascending_order(self):
        """Test case where the array is already sorted in ascending order."""
        array = [1, 3, 5, 7, 9, 11]
        result = counting_sort_function(array, 12)
    ...
    def test_descending_order(self):
        ...
        array = [10, 8, 6, 4, 2]
        result = counting_sort_function(array, 11)
    ...
    def test_unsorted_array(self):
        ...
        result = counting_sort_function(array, 19)
